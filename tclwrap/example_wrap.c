...
SWIGINTERN int
_wrap_my_num(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,":my_num ") == TCL_ERROR) SWIG_fail;
  result = (int)my_num();
  Tcl_SetObjResult(interp,SWIG_From_int((int)(result)));
  return TCL_OK;
fail:
...
SWIGINTERN int
_wrap_printhello(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":printhello ") == TCL_ERROR) SWIG_fail;
  printhello();
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "my_num", (swig_wrapper_func) _wrap_my_num, NULL},
    { SWIG_prefix "printhello", (swig_wrapper_func) _wrap_printhello, NULL},
    {0, 0, 0}
};
